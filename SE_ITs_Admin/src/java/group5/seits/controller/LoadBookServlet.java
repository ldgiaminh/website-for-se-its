 ...
 * @author ADMIN
 */
@WebServlet(name = "LoadBookServlet", urlPatterns = {"/loadBook"})
public class LoadBookServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("DETAIL_BOOK", b);
            
            CategoryDAO bookDao = new CategoryDAO();
            List<CategoryBookDTO> listCateBook = bookDao.loadCateBook();
            ...
            log("LoadBookServlet SQL: " + ex.getMessage());
        } catch (NamingException ex) {
            log("LoadBookServlet Naing: " + ex.getMessage());
        } finally {
