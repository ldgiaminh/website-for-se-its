 ...
 * @author PC
 */
@WebServlet(name = "CategoryNewsServlet", urlPatterns = {"/CategoryNewsServlet"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
           HttpSession session = request.getSession(false);
            ...
            RequestDispatcher rd = request.getRequestDispatcher("cateNews.jsp");
            rd.forward(request, response);    
        }
        catch (SQLException ex) {
            log("CategoryNewsServlet SQL: " + ex.getMessage());
        } catch (NamingException ex) {
            log("CategoryNewsServlet Naming: " + ex.getMessage());
        }
        finally{
