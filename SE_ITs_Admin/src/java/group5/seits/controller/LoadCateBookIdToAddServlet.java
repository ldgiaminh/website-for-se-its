 ...
 * @author PC
 */
@WebServlet(name = "LoadCateBookIdToAddServlet", urlPatterns = {"/LoadCateBookIdToAddServlet"})
public class LoadCateBookIdToAddServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (CategoryBookDTO list : listCateBook) {
