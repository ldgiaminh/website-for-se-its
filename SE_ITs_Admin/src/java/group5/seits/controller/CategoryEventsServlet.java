 ...
 * @author PC
 */
@WebServlet(name = "CategoryEventsServlet", urlPatterns = {"/CategoryEventsServlet"})
public class CategoryEventsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            RequestDispatcher rd = request.getRequestDispatcher("cateEvents.jsp");
