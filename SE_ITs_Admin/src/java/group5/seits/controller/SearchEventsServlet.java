...
public class SearchEventsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String searchValue = request.getParameter("txtSearchValueEvents");
            EventsDAO dao = new EventsDAO();
            List<EventsDTO> result = dao.searchEvents(searchValue);
            request.setAttribute("LIST_EVENT_SEARCH", result);
