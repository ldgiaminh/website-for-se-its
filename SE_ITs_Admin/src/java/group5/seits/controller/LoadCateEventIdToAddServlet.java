 ...
 * @author PC
 */
@WebServlet(name = "LoadCateEventIdToAddServlet", urlPatterns = {"/LoadCateEventIdToAddServlet"})
public class LoadCateEventIdToAddServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       request.setCharacterEncoding("UTF-8");
        ...
        try {
            ...
            List<CategoryDTO> listCateEvent = dao.loadCateEvents();
            request.setAttribute("LIST_CATE_EVENT", listCateEvent);
