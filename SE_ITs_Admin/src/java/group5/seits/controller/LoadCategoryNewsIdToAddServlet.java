 ...
 * @author PC
 */
@WebServlet(name = "LoadCategoryNewsIdToAddServlet", urlPatterns = {"/LoadCategoryNewsIdToAddServlet"})
public class LoadCategoryNewsIdToAddServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("LoadCategoryNewsIdToAddServlet SQL: " + ex.getMessage());
        } catch (NamingException ex) {
            log("LoadCategoryNewsIdToAddServlet Naming: " + ex.getMessage());
        }
        finally{
