<%-- 
    ...
    Created on : Mar 24, 2022, 10:08:20 PM
    Author     : PC
--%>
                                    ...
                                    <div class="card-header">
                                        <div class="card-header-title">
                                            ...
                                            <h4 class="card-title-add">
                                                <a href="addLecturer.jsp" class="card-header-link">
                                                 Add New Lecturer
                                                </a>
                                            </h4>
                                        </div>
                                        <p class="card-description">
                                        Here is the table for add new Lecturer
                                        </p>
                                    </div>
                                    <form action="AddLecturerServlet" method="post">
                                        <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <input name="lecturerId" type="text" class="form-control" id="exampleInputId" placeholder="ID">
                                                </div>   
                                                <div class="form-group">
                                                    <label for="exampleInputName">Name</label>
                                                    <input name="lecturerName" type="text" class="form-control" id="exampleInputName" placeholder="Name">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputImage">Image</label>
                                                    <textarea name="lecturerImage" class="form-control" id="exampleInputImage" rows="4"></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleDesc">Description</label>
                                                    <textarea name="lecturerDes" class="form-control" id="exampleDesc" rows="4"></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputDate">Create Date</label>
                                                    <input name="lecturerDate" type="text" class="form-control" id="exampleInputDate" >                                       
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputQuotes">Quotes</label>
                                                    <textarea name="lecturerQuotes" class="form-control" id="exampleInputQuotes" rows="4"></textarea>
                                                </div>
                                                <div class="form-group">
                                                        <label for="exampleCateSubjectId">Category Subject ID</label>
                                                        <select name="categorySubjectId" class="form-control" rows="4">
                                                            <c:set var="listCateSubjectId" value="${requestScope.LIST_SUBJECT_TO_ADD_LEC}"/>
