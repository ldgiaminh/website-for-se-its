<%-- 
    Document   : addcateNews
    Created on : Apr 2, 2022, 11:58:40 PM
    Author     : PC
--%>
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <p class="card-description">
                                                Here is the table for add new tag News
                                            </p>
                                        </div>
                                        <form action="AddCateNewsServlet" method="post">
                                            <div class="card-body">

                                                <div class="form-group">
                                                    <label for="exampleInputTitle">ID</label>
                                                    <input name="cateNewsId" type="text" class="form-control" id="exampleInputId" placeholder="ID">
                                                </div>    
                                                <div class="form-group">
                                                    <label for="exampleInputName">Name</label>
                                                    <input name="cateNewsName" type="text" class="form-control" id="exampleInputName" placeholder="Name">
                                                </div>
