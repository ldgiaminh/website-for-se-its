<%-- 
    Document   : addcateEvents
    Created on : Apr 3, 2022, 12:00:20 AM
    Author     : PC
--%>
            ...
            <div class="main-panel">
                ...
                <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                    <div class="container-fluid">
                        <a href="index.html" class="container-logo">
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <div class="card-header-title">
                                                <h4 class="card-title">
                                                    <a href="category.html" class="card-header-link">
                                                        Category Table
                                                    </a>
                                                </h4>
                                                ...
                                                <h4 class="card-title-add">
                                                    <a href="addSubject.html" class="card-header-link">
                                                        Add New Tag Events
                                                    </a>
                                                </h4>
                                            </div>
                                            <p class="card-description">
                                                Here is the table for add new tag Events
                                            </p>
                                        </div>
                                        <form action="AddCateEventServlet" method="post">
                                            <div class="card-body">

                                                <div class="form-group">
                                                    <label for="exampleInputTitle">ID</label>
                                                    <input name="cateEventId" type="text" class="form-control" id="exampleInputId" placeholder="ID">
                                                </div>    
                                                <div class="form-group">
                                                    <label for="exampleInputName">Name</label>
                                                    <input name="cateEventName" type="text" class="form-control" id="exampleInputName" placeholder="Name">
                                                </div>
