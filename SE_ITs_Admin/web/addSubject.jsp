                                    ...
                                    <form action="AddSubjectServlet" method="post">
                                        <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="subDes" class="form-control" id="exampleInputImage" rows="4"></textarea>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="categorySubjectId" class="form-control" rows="4">
                                                        <c:set var="listCateSubject" value="${requestScope.LIST_CATE_SUBJECT_TO_ADD_SUBJECT}"/>
